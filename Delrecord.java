...
public class Delrecord extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		String deleteaction = request.getParameter("getdeleteval");
		String[] arrOfStr = deleteaction.split(",", 11);
		...
		try {
			...
			Statement st=con.createStatement();
				...
				{
					int ind=Integer.parseInt(arrOfStr[i]);
					String query = "delete from mytable where label="+ind+"";
